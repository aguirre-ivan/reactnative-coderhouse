...
const Game = ({ selectedNumber, onHandleGameOver }) => {
  ...
  const onHandleNextGuess = (direction) => {
    if (
      ...
      Alert.alert("Don't lie!", "The number is incorrect...", [
  ...
  return (
    <View style={styles.container}>
      <Card style={styles.content}>
        <Text style={styles.title}>Number of player</Text>
        <NumberContainer number={currentGuess} />
        <View style={styles.buttonContainer}>
          <Button title="Lower" onPress={() => onHandleNextGuess("lower")} color={colors.primary} />
          <Button
            title="Greater"
